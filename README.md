...
Beach Shop is an online website where users can browse different beach products one might need for a day at the beach. Users can add products to a cart and checkout. Users can check on past orders, create a profile and leave product reviews.
